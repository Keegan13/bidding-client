...
const OrderByLevel = (notifications) => {
    return notifications.sort((left, right) => {
        return left.level > right.level ? 1 : 0;
    });
};

const NotificationQueue = ({ notifications = [], onNotificationClick, onNotificationClose, onNotificationTimeout, ...other }) => {
